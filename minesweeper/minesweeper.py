...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_sentence = Sentence([cell], count)  # Create a new sentence based on cell and count
        ...
        additional_safe_cells = set()
        additional_mine_cells = set()
        ...
        for sentence in self.knowledge:
            ...
            if known_mines:
                additional_mine_cells |= known_mines
            if known_safes:
                additional_safe_cells |= known_safes

        # Update the safe and mine cells in the knowledge base
        self.safes |= additional_safe_cells
        self.mines |= additional_mine_cells
